...
// cryptonight_monero || cryptonight_aeon || cryptonight_hosp || cryptonight_stellite || cryptonight_masari || cryptonight_bittube2
...
// cryptonight_hosp || cryptonight_bittube2
#	if(ALGO == 6 || ALGO == 10)
			uint2 hosp_tmp = tweak1_2 ^ ((uint2 *)&(a[0]))[0];
			((uint2 *)&(a[1]))[0] ^= hosp_tmp;
